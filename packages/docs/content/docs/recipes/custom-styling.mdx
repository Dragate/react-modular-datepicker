...
export function NeumorphicCalendar() {
  return (
    <Calendar
      classNames={{
        root: 'bg-[#faf9f6] p-6 rounded-2xl border border-stone-200/50 shadow-[4px_4px_12px_#e6e3dc,-4px_-4px_12px_#ffffff] text-stone-800',
        header: 'border-b border-stone-200/60 pb-3 mb-3',
        navButton: 'p-1.5 text-stone-600 hover:bg-stone-200/40 rounded-xl',
        ...
        daysGrid: 'gap-2 bg-transparent',
        day: {
          day: 'aspect-square rounded-xl bg-[#faf9f6] text-stone-700 shadow-[2px_2px_5px_#e6e3dc,-2px_-2px_5px_#ffffff] hover:shadow-[inset_1.5px_1.5px_3px_#e6e3dc,inset_-1.5px_-1.5px_3px_#ffffff]',
