...
description: Build event or schedule calendars with event indicators, tooltips, or full Google Calendar style month views.
---

# Event & Schedule Calendar

The `<Calendar />` component and the `useDates` hook support custom modifiers, tooltips, and custom cell rendering, making it straightforward to build event and schedule calendars.

## Event Indicator View

Pass custom modifiers and day class names to display event dots/indicators on dates with scheduled events.
