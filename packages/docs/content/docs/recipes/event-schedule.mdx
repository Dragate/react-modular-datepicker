...
description: Build event or schedule calendars with event indicators, CSS-only tooltips, or full Google Calendar style month views.
---
...
Pass custom modifiers and day class names with CSS pseudo-elements (`before:` / `after:`) to display event indicators and hover tooltips without extra JavaScript.
