...
If you want a polished, pre-styled datepicker out of the box, use the `<Calendar />` component. It handles navigation buttons, month headers, weekday grids, state styling, tooltips, and month/year pickers automatically.
...
If you need complete design freedom—for instance, building a full-page Google Calendar-style event planner, custom popover pickers, or proprietary design systems—use the `useDates` hook.
